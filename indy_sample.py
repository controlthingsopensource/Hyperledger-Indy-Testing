...
pool_name             = 'Test_pool'
pool_genesis_txn_path = os.getcwd()+'/test_pool/indy_sample_genesis_txn'
'''
This Steward is part of the indy-sdk testing network
'''
steward = {
    'name': "Steward",
    'wallet_config': json.dumps({'id': 'steward_wallet', "storage_config":{"path":"."}}),
...
endorser = {
    'name': "Endorser",
    'wallet_config': json.dumps({'id': 'endorser_wallet', "storage_config":{"path":"."}}),
...
cred_values = json.dumps({
    "resources": {"raw": "controlthings.gr", "encoded": "5"}, 
